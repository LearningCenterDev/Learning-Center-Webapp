...
export default function About() {
  return (
    <div className="bg-gradient-to-b from-blue-50 via-blue-25 to-blue-100 text-slate-800 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <FadeInWhenVisible>
            <div className="text-center mb-10 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-800 mb-4 sm:mb-6">Our Mission</h2>
              <p className="text-base sm:text-lg text-slate-700 max-w-4xl mx-auto leading-relaxed px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <FadeInWhenVisible delay={0.1}>
              <div className="text-center p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-blue-200 h-full">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <Users className="w-6 h-6 sm:w-8 sm:h-8 text-blue-700" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2">Student-Focused</h3>
                <p className="text-sm sm:text-base text-slate-700">Designed with learners in mind, from elementary to college level.</p>
              </div>
            </FadeInWhenVisible>
            ...
            <FadeInWhenVisible delay={0.2}>
              <div className="text-center p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-blue-200 h-full">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <Target className="w-6 h-6 sm:w-8 sm:h-8 text-blue-700" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2">Practical Learning</h3>
                <p className="text-sm sm:text-base text-slate-700">Real-world projects and hands-on experience with industry tools.</p>
              </div>
            </FadeInWhenVisible>
            ...
            <FadeInWhenVisible delay={0.3}>
              <div className="text-center p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-blue-200 h-full">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <Award className="w-6 h-6 sm:w-8 sm:h-8 text-blue-700" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2">Expert Instructors</h3>
                <p className="text-sm sm:text-base text-slate-700">Learn from experienced professionals and educators.</p>
              </div>
            </FadeInWhenVisible>
            ...
            <FadeInWhenVisible delay={0.4}>
              <div className="text-center p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-blue-200 h-full">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <Heart className="w-6 h-6 sm:w-8 sm:h-8 text-blue-700" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2">Supportive Community</h3>
                <p className="text-sm sm:text-base text-slate-700">Join a community of learners and mentors who care about your success.</p>
              </div>
            </FadeInWhenVisible>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <FadeInWhenVisible>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-800 mb-4 sm:mb-6">Our Story</h2>
                <p className="text-base sm:text-lg text-slate-700 mb-3 sm:mb-4 leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-blue-200">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-700 mb-2">10K+</div>
                  <div className="text-xs sm:text-sm text-slate-700">Students Served</div>
                </div>
                <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-blue-200">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-700 mb-2">500+</div>
                  <div className="text-xs sm:text-sm text-slate-700">Active Courses</div>
                </div>
                <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-blue-200">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-700 mb-2">50+</div>
                  <div className="text-xs sm:text-sm text-slate-700">Expert Instructors</div>
                </div>
                <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-blue-200">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-700 mb-2">95%</div>
                  <div className="text-xs sm:text-sm text-slate-700">Success Rate</div>
                </div>
              </div>
            </div>
          </FadeInWhenVisible>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-blue-100 via-white to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <FadeInWhenVisible>
            <div className="text-center mb-10 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-800 mb-4 sm:mb-6">Why Choose LearnOne?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <FadeInWhenVisible delay={0.1}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">🎓</div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2 sm:mb-3">Age-Appropriate Curriculum</h3>
            ...
            <FadeInWhenVisible delay={0.2}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">🏆</div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2 sm:mb-3">Project-Based Learning</h3>
                <p className="text-sm sm:text-base text-slate-700">
            ...
            <FadeInWhenVisible delay={0.3}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">🚀</div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2 sm:mb-3">Industry-Relevant Skills</h3>
                <p className="text-sm sm:text-base text-slate-700">
            ...
            <FadeInWhenVisible delay={0.4}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">👥</div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2 sm:mb-3">Personalized Support</h3>
                <p className="text-sm sm:text-base text-slate-700">
            ...
            <FadeInWhenVisible delay={0.5}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">💡</div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2 sm:mb-3">Flexible Learning</h3>
                <p className="text-sm sm:text-base text-slate-700">
            ...
            <FadeInWhenVisible delay={0.6}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">🌟</div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2 sm:mb-3">Continuous Updates</h3>
                <p className="text-sm sm:text-base text-slate-700">
      ...
      {/* Values Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-blue-50 via-blue-100 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <FadeInWhenVisible>
            <div className="text-center mb-10 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 mb-4 sm:mb-6">Our Core Values</h2>
            </div>
          </FadeInWhenVisible>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            <FadeInWhenVisible delay={0.1}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">🧠 Accessibility</h3>
            ...
            <FadeInWhenVisible delay={0.2}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">🎯 Excellence</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
            ...
            <FadeInWhenVisible delay={0.3}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">🤝 Community</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
            ...
            <FadeInWhenVisible delay={0.4}>
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-200 h-full">
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">📈 Growth</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-white via-blue-50 to-blue-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <FadeInWhenVisible>
            <div className="bg-white border-4 border-blue-500 text-blue-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl relative overflow-hidden backdrop-blur-md">
              ...
              <div className="relative z-10">
                ...
                <a
                  href="/courses"
                  className="inline-block px-8 sm:px-10 py-3 sm:py-4 md:py-5 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 hover:from-blue-700 hover:to-blue-800 text-sm sm:text-base"
                >
                  Explore Our Courses
                </a>
              </div>
